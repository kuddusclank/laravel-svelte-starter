...
<div class="relative">
    ...
    {#if menuOpen}
        ...
        <div
            class="preset-elevated-surface-50-950 absolute bottom-full left-0 z-50 mb-2 w-full rounded-lg border p-1 shadow-lg"
        >
            <UserInfo {user} />
            <hr class="border-surface-200-800 my-1" />
            <a
                href="/settings/profile"
                class="hover:bg-surface-200-800 flex items-center gap-2 rounded-md px-3 py-2 text-sm"
            >
